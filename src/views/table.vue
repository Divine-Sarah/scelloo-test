<template>
    <main class="app-container">
        <div class=" space-y-[20px]">
            <h1 class="text-sm font-bold uppercase text-text-purple">Table Heading</h1>
            <div class="flex items-center justify-between border-b-2 border-apppurple-100">
                <div class="flex space-x-[30px] ">
                    <div v-for="(tab, index) in tabs" :key="index" :class="[
                        ...
                        {
                            'text-apppurple-200 border-b-2 border-apppurple-200  px-3': activeTab === index,
                ...
                <div class="flex items-center font-inter">
                    ...
                    <figure class="text-lg font-bold text-apppurple-300">$900.00 <span
                            class="text-lg font-normal text-text-purple">USD</span>
                    </figure>
                </div>
            </div>
            <Layout />
